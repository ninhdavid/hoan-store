...
const CollectionWrapper = (props: Props) => {
    ...
    return (
        <main
            ref={containerRef}
            className='h-[3200px] mt-[-300px] bg-white -mx-6 md:-mx-[30px] lg:-mx-[48px] xl:-mx-[60px] 2xl:-mx-[130px]'>
            <div className='flex h-full w-full ml-[-3px]'>
                <motion.div
                    style={style}
                    className='bg-black top-0 z-20 relative'>

                    <div className='absolute pt-[700px] pb-[200px] w-full h-full '>
