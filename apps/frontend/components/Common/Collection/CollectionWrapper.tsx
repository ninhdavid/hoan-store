...
const CollectionWrapper = (props: Props) => {
    ...
    const clipPath = useTransform(
        scrollYProgress,
        [0, 1],
        ['circle(0% at 0% 0%)', 'circle(166% at 0% 0%)']
    );
    ...
    return (
        <main
            ref={containerRef}
            className="h-[3200px] mt-[-200px] bg-white -mx-6 md:-mx-[30px] lg:-mx-[48px] xl:mt-[-230px] xl:-mx-[60px] 2xl:mt-[-260px] 2xl:-mx-[140px]"
        >
            <div className="flex h-full w-full ">
                <motion.div style={style} className="bg-black top-0 z-20 relative">
