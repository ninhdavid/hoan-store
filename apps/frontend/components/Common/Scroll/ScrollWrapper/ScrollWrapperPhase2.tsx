    ...
    return (
        <main className="w-full">
            <section
                ...
                className="relative h-[3000px] z-20 -mx-6 md:-mx-[30px] lg:-mx-[48px] xl:-mx-[60px] 2xl:-mx-[140px]"
            >
                <ScrollScaleCardPhase2 scrollYProgress={scrollYProgress} />
            </section>

            <motion.section className=" relative z-30 mt-[-1200px]">
                <motion.div
                    whileInView={{ opacity: 1, y: 0 }}
                    initial={{ opacity: 0, y: 200 }}
                    transition={{ duration: 0.5, delay: 0.5 }}
                    className="z-30 bg-white min-h-[360px] rounded-3xl p-[30px] xl:h-[420px] 2xl:h-[460px] "
                >
