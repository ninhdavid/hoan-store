                ...
                <div className="flex justify-center flex-col">
                    <div className="lg:flex lg:flex-row">
                        <section className="lg:w-[50%]">
                            <div className="text-lg font-medium mb-6 lg:w-[75%] xl:text-xl">
                                <p>
                                    Sign up for THgiay&apos;s new, launches and special offers -
                            ...
                            <div className="flex flex-col">
                                ...
                                >
                                    ...
                                    <div className="divHover">
                                        <div className="mb-4 linkHover">
                                            <Link href="/">Personalize</Link>
                                        </div>
                                        <div className="mb-4 linkHover">
                                            <Link href="/">Refreshed</Link>
                                        </div>
                                        <div className="mb-4 linkHover">
